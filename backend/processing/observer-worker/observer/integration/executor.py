...
class BaseObserverExecutor(BaseSettings):
    ...
    @abstractmethod
    def get_config(self, event: ObserverJobEvent, config: SourceConfig):
        pass
    ...
    def fetch_data(self, event: ObserverJobEvent, config: Optional[SourceConfig] = None) -> List[ObseiResponse]:
