...
class EntityRedisProvider(BaseSettings):
    ...
    def _set_expiry(self, entity_key: str, expiry_at: Optional[int] = None, ttl: Optional[int] = None):
        if ttl:
            ...
            self._client.expire(entity_key, app_settings.DEFAULT_MAX_CACHE_TTL_SECONDS)
    ...
    def set_entity(self, entity_id: str, entity: Dict[str, str], expiry_at: Optional[int] = None, ttl: Optional[int] = None):
