...
from service.app.visualization.dynamic_dashboard.handler._common_dashboard_handle import get_query_result
from service.app.visualization.dynamic_dashboard.handler._echarts_util import echarts_option_translation_update
from service.app.visualization.model.chart_models import ChartDBO, FilterDO
...
def handle_chart(component_inputs: List[FieldValue], filter_list: List[FilterDO], tenant_code: str, chart: ChartDBO):
